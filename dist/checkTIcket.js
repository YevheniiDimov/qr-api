...
function checkTicket(umi, ticketPublicKey, collectionPublicKey) {
    return __awaiter(this, void 0, void 0, function () {
        var ticketItem, fetchPromise, ticket, visitsTrait, allowedVisitsTrait, expiryTimeTrait, collectionItem;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, mpl_token_metadata_1.fetchDigitalAsset)(umi, ticketPublicKey)];
                case 1:
                    ticketItem = _a.sent();
                    if (!ticketItem) {
                    ...
                    return [4 /*yield*/, fetch(ticketItem.metadata.uri)];
                case 2:
                    fetchPromise = _a.sent();
                    return [4 /*yield*/, fetchPromise.json()];
                case 3:
                    ticket = _a.sent();
                    visitsTrait = ticket.attributes.find(function (trait) { return trait.trait_type === "visits"; });
                    allowedVisitsTrait = ticket.attributes.find(function (trait) { return trait.trait_type === "allowed_visits"; });
                    expiryTimeTrait = ticket.attributes.find(function (trait) { return trait.trait_type === "expiry_time"; });
                    ...
                    return [4 /*yield*/, (0, mpl_token_metadata_1.fetchDigitalAsset)(umi, collectionPublicKey)];
                case 4:
                    collectionItem = _a.sent();
                    if (!collectionItem) {
                    ...
                    return [2 /*return*/, ticketItem.metadata.collection.value.key === collectionPublicKey];
            }
        });
    });
}
